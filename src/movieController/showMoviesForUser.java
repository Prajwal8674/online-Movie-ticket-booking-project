				...
				try {
					ArrayList<pojo> p = md.getallMovies();
					 out.println("<!DOCTYPE html>");
				        ...
				        out.println("<li class=\"navitem\"><a href=\"HomeUser.html\">Home</a></li>");
				        out.println("<li class=\"navitem\"><a class=\"active\"href=\"#\">Show Movies</a></li>");
				        out.println("<li class=\"navitem\"><a href=\"\">Purchase History</a></li>");
				        out.println("<li class=\"navitem\"><a href=\"http://localhost:8084/MyWeb/logout\">Log Out</a></li>");
				        out.println("</ul>");
